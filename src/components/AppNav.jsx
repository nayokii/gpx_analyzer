 ...
 * que deux composants différents, pour ne jamais faire diverger les 5
 * destinations entre les deux tailles d'écran. Le bouton "Importer" reste
 * dans le bandeau supérieur uniquement : à 5 items déjà présents, l'ajouter
 * à la barre basse la rendrait illisible sur mobile (voir consigne §9).
 */
import { Home, History as HistoryIcon, UserRound, Trophy, Fingerprint, Upload } from "lucide-react";
