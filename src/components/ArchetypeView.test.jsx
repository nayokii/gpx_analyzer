...
describe("ArchetypeView — Phase 11B : profil basé sur l'historique unifié (local + cloud)", () => {
  afterEach(async () => {
  ...
  it("calcule l'archétype à partir d'une sortie disponible uniquement dans le cloud", async () => {
